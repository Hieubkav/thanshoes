...
class WebsiteDesign extends Page implements Forms\Contracts\HasForms
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('WebsiteDesign')
                    ->tabs([
                        // Stats Tab
                        ...
                        // Services Tab
                        Forms\Components\Tabs\Tab::make('Dịch vụ')
                            ->schema([
                        ...
                        // Effects Tab
                        Forms\Components\Tabs\Tab::make('Công dụng sản phẩm')
                            ->schema([
                        ...
                        // Other Elements Tab
                        Forms\Components\Tabs\Tab::make('Các phần khác')
                            ->schema([
                        ...
                        // Certificate Tab
                        Forms\Components\Tabs\Tab::make('Chứng nhận')
                            ->schema([
                        ...
                        // Video & About Tab
                        Forms\Components\Tabs\Tab::make('Video & Giới thiệu')
                            ->schema([
                                // Video Section
