...
<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('posts.index') }}" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2">Bài viết</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-gray-500 md:ml-2 line-clamp-1">{{ $post->title }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <article class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        @else
            <div class="w-full h-64 bg-gradient-to-br from-blue-100 via-blue-200 to-blue-100 flex items-center justify-center">
