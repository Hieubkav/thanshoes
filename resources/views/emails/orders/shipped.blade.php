    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 15px; overflow: hidden; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: rgba(255, 255, 255, 0.9); border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 18px; color: #2D3748; margin: 0 0 10px;"><strong>💰 Tổng giá trị:</strong> <span style="color: #48BB78; font-weight: bold;">{{ number_format($order->order_items->sum('price'), 0, ',', '.') }}đ</span></p>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: separate; border-spacing: 0 15px;">
                    ...
                    <tr>
                        <td width="100" style="vertical-align: middle;">
                            <img src="{{ $item->variant->variant_images->first()->image }}" alt="{{ $item->variant->product->name }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        </td>
        ...
        <tr>
            <td style="padding: 30px; background: linear-gradient(135deg, #6B46C1 0%, #3B82F6 100%); text-align: center;">
                <p style="font-size: 24px; color: #ffffff; margin: 0; text-shadow: 1px 1px 2px rgba(0,0,0,0.3);">🎉 Tổng số sản phẩm: <strong>{{ $order->order_items->sum('quantity') }}</strong> 🎉</p>
            </td>
        </tr>
        <tr>
            <td style="padding: 30px; text-align: center; background-color: #F7FAFC;">
                ...
                <a href="#" style="display: inline-block; padding: 12px 24px; background-color: #48BB78; color: #ffffff; text-decoration: none; font-weight: bold; border-radius: 5px; font-size: 16px; transition: background-color 0.3s ease;">Xem chi tiết đơn hàng</a>
            </td>
        </tr>
    </table>
</body>
