...
data-drawer-target="drawer_cart" data-drawer-show="drawer_cart" data-drawer-backdrop="false"
data-drawer-placement="right" aria-controls="drawer_cart" data-drawer-body-scrolling="true" class="rounded-md cartBtn flex items-center justify-center gap-2 w-40 h-12 bg-blue-600 text-white font-medium shadow-lg transition-transform transform hover:scale-95" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false">
